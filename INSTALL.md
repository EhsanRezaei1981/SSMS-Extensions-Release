# Jarvis SSMS Extension 2026.903.1.16
...
| file | what it is |
|---|---|
| Jarvis.SSMSExtension-2026.903.1.16.vsix | the extension |
| jsqlfmt-2026.903.1.16.zip | the command line formatter, for hooks and CI |
