# Jarvis SSMS Extension 2026.909.1.1
...
| file | what it is |
|---|---|
| Jarvis.SSMSExtension-2026.909.1.1.vsix | the extension |
| jsqlfmt-2026.909.1.1.zip | the command line formatter, for hooks and CI |
