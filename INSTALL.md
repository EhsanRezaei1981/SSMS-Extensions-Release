# Jarvis SSMS Extension 2026.903.1.14
...
| file | what it is |
|---|---|
| Jarvis.SSMSExtension-2026.903.1.14.vsix | the extension |
| jsqlfmt-2026.903.1.14.zip | the command line formatter, for hooks and CI |
