# Jarvis SSMS Extension 2026.909.1.3
...
| file | what it is |
|---|---|
| Jarvis.SSMSExtension-2026.909.1.3.vsix | the extension |
| jsqlfmt-2026.909.1.3.zip | the command line formatter, for hooks and CI |
