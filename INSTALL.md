# Jarvis SSMS Extension 2026.903.1.15
...
| file | what it is |
|---|---|
| Jarvis.SSMSExtension-2026.903.1.15.vsix | the extension |
| jsqlfmt-2026.903.1.15.zip | the command line formatter, for hooks and CI |
