# Jarvis SSMS Extension 2026.911.1.2
...
| file | what it is |
|---|---|
| Jarvis.SSMSExtension-2026.911.1.2.vsix | the extension |
| jsqlfmt-2026.911.1.2.zip | the command line formatter, for hooks and CI |
