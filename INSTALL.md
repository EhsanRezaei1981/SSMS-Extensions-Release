# Jarvis SSMS Extension 2026.909.1.4
...
| file | what it is |
|---|---|
| Jarvis.SSMSExtension-2026.909.1.4.vsix | the extension |
| jsqlfmt-2026.909.1.4.zip | the command line formatter, for hooks and CI |
