...
$sourceDll = Join-Path (Split-Path -Parent $PSScriptRoot) 'src\Jarvis.SqlFormatter.Vsix\bin\Release\Jarvis.SqlFormatter.Vsix.dll'
...
function Test-Registration {
    ...
    $installedDll = Join-Path $installedAt 'Jarvis.SqlFormatter.Vsix.dll'
